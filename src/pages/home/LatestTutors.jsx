...
const mockTutors = [
    {
        ...
        isPremium: true,
        photoURL: "https://i.ibb.co.com/DH2pZ0dV/photo-1640951613773-54706e06851d.jpg", // Replace with actual tutor photos
    },
    {
        id: 2,
        ...
        >
            ...
            <div className="relative mb-4">
                ...
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 bg-white dark:bg-gray-700 rounded-full p-1 shadow-xl">
                    <CheckCircle className={`w-5 h-5 ${isPremium ? premiumColor : 'text-primary'} fill-white dark:fill-gray-800`}/>
                </div>
            </div>
    ...
    return (
        ...
        >
            <div className="container mx-auto px-4">
                ...
                <div className="relative pb-10"> {/* Padding bottom for pagination dots */}
                    <Swiper
